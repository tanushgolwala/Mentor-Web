...
const Listing = () => {
  return (
    <div>
      ...
      <Products />
      {/* <Footer /> */}
      <div className="bg-black justify-between text-white grid grid-cols-2 sm:grid-cols-2 col-span-2 md:pl-10">
        <div>
          <div className="py-8 px-4 justify-center">
            ...
            <p>Find an ideal mentor for enhancing your skillset!</p>
          </div>
        </div>
        {/* social links */}
